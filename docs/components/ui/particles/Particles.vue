...
<template>
  <div class="stars pointer-events-none absolute inset-x-0 bottom-0 h-48 opacity-75 md:h-80 lg:h-[350px] lg:w-[450px] 2xl:h-[350px]" :class="{ accelerate: props.accelerate }">
