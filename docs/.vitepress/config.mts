...
const newComponents = [
	{ text: "Animated Subscribe Button", link: "/content/components/animated-subscribe-button.md" },
	{ text: "Client Tweet Card", link: "/content/components/client-tweet-card.md" },
	{ text: "Floating 3D Particles", link: "/content/components/floating-3d-particles.md" },
	{ text: "Magic Card", link: "/content/components/magic-card.md" },
	{ text: "Morphing Text", link: "/content/components/morphing-text.md" },
	{ text: "Neon Gradient Card", link: "/content/components/neon-gradient-card.md" },
	{ text: "Noise Texture", link: "/content/components/noise-texture.md" },
	{ text: "Number Ticker", link: "/content/components/number-ticker.md" },
	{ text: "Pixel Image", link: "/content/components/pixel-image.md" },
	{ text: "Pointer", link: "/content/components/pointer.md" },
	{ text: "Progressive Blur", link: "/content/components/progressive-blur.md" },
	{ text: "Pulsating Button", link: "/content/components/pulsating-button.md" },
	{ text: "Rainbow Button", link: "/content/components/rainbow-button.md" },
	{ text: "Ripple Button", link: "/content/components/ripple-button.md" },
	{ text: "Safari", link: "/content/components/safari.md" },
	{ text: "Scroll Based Velocity", link: "/content/components/scroll-based-velocity.md" },
	{ text: "Shimmer Button", link: "/content/components/shimmer-button.md" },
	{ text: "Shine Border", link: "/content/components/shine-border.md" },
	{ text: "Shiny Button", link: "/content/components/shiny-button.md" },
	{ text: "Smooth Cursor", link: "/content/components/smooth-cursor.md" },
	{ text: "Sparkles Text", link: "/content/components/sparkles-text.md" },
	{ text: "Spinning Text", link: "/content/components/spinning-text.md" },
	{ text: "Striped Pattern", link: "/content/components/striped-pattern.md" },
	{ text: "Text 3D Flip", link: "/content/components/text-3d-flip.md" },
	{ text: "Text Animate", link: "/content/components/text-animate.md" },
	{ text: "Text Reveal", link: "/content/components/text-reveal.md" },
	{ text: "Tweet Card", link: "/content/components/tweet-card.md" },
	{ text: "Video Text", link: "/content/components/video-text.md" },
	{ text: "Warp Background", link: "/content/components/warp-background.md" },
	{ text: "Word Rotate", link: "/content/components/word-rotate.md" },
